...
<template>
  <div class="min-h-screen bg-slate-100 py-10">
    <div class="mx-auto flex max-w-6xl flex-col gap-10 px-5">
      <header
        class="flex flex-col gap-4 rounded-2xl bg-white p-6 shadow-sm md:flex-row md:items-center md:justify-between"
      >
        <div>
